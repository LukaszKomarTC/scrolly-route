export const coastalExplorer = {
  ...
  hero: {
    image: {
      ...
      alt: 'Cyclists on the clifftop above a turquoise cove on the Costa Brava',
  ...
  chapters: [
    ...
    { id: 'tossa-from-above', image: { src: 'routes/coastal-explorer/photos/tossa-from-above.jpg', alt: 'Riders at the Tossa de Mar viewpoint, the old town and castle across the bay', credit: 'Tossa Cycling', consent: 'pending — recognisable riders, confirm marketing consent before production' }, eyebrow: 'Viewpoint · km 1.4', title: 'Tossa from Above', body: 'The first scenic payoff arrives almost immediately. From this mirador, the cove of Tossa de Mar opens below — sea, cliffs and town framed by the Mediterranean landscape.', routeKm: 1.44, point: [2.942273, 41.726259], camera: { center: [2.942273, 41.726259], zoom: 14.7, pitch: 55, bearing: 70 } },
    ...
    { id: 'sant-elm', image: { src: 'routes/coastal-explorer/photos/sant-elm.jpg', alt: 'Riders resting at a viewpoint above the cove near Ermita de Sant Elm', credit: 'Tossa Cycling', consent: 'pending — recognisable riders, confirm marketing consent before production' }, eyebrow: 'Costa Brava story · km 30.2', title: 'Where the Costa Brava Gets Its Name', body: 'Ermita de Sant Elm is traditionally associated with Ferran Agulló’s naming of the Costa Brava — the “Wild Coast”. From here the rugged stretch toward Tossa explains the name perfectly. Today the Costa Brava runs from Blanes to the French border, but this landscape is central to its origin story.', routeKm: 30.18, point: [3.027348, 41.7746362], camera: { center: [3.027348, 41.7746362], zoom: 13.4, pitch: 58, bearing: 225 } },
